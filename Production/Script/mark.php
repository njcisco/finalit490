...
function download_pkg($lvl,$machineType,$file)
{
                ...
                //ask VersionControl for this old pkg
...
function getFile()//get the zip filename from Files directory in this vm
{		echo"Rollback started".PHP_EOL;
		echo "===================================================================".PHP_EOL;
